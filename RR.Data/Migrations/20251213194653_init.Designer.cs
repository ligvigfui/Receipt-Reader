...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RR.Data.DataBaseObjects.CategoryDBO", b =>
                {
                    ...
                    b.Property<bool>("CategoryDefinition")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("RR.Data.DataBaseObjects.LanguageDBO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RR.Data.DataBaseObjects.MeasurementDBO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<float>("ConversionFactorToSI")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("RR.Data.DataBaseObjects.ReceiptItemDBO", b =>
                {
                    ...
                    b.Property<int?>("ProductAliasId")
                        .HasColumnType("int");

                    b.Property<int?>("ProductDBOId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductAliasId");

                    b.HasIndex("ProductDBOId");
            ...
            modelBuilder.Entity("RR.Data.DataBaseObjects.UserGroupDBO", b =>
                {
                    ...
                    b.Property<bool>("CanEditGroupPermissions")
                        .HasColumnType("bit");

                    b.Property<bool>("CanEditOwn")
                        .HasColumnType("bit");

                    b.Property<bool>("CanRead")
                        .HasColumnType("bit");

                    b.Property<bool>("CanReadOwn")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("RR.Data.DataBaseObjects.ProductDBO", b =>
                {
                    ...
                    b.HasOne("RR.Data.DataBaseObjects.MeasurementDBO", "Measurement")
                        .WithMany()
            ...
            modelBuilder.Entity("RR.Data.DataBaseObjects.ReceiptItemDBO", b =>
                {
                    ...
                    b.HasOne("RR.Data.DataBaseObjects.ProductAliasDBO", "ProductAlias")
                        .WithMany()
                        .HasForeignKey("ProductAliasId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("RR.Data.DataBaseObjects.ProductDBO", null)
                        .WithMany("ReceiptItems")
                        .HasForeignKey("ProductDBOId");
